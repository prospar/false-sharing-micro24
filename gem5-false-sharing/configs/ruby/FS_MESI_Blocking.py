"""
The configuration file for MESI modification performed
to support DeFT Refer : configs/ruby/MESI_Two_Level.py
"""
...
def define_options(parser):
    parser.add_option("--inv_threshold", type="int", default="5000",
                      help="number of invalidation message threshold")
    parser.add_option("--fetch_threshold", type="int", default="5000",
    ...
    parser.add_option("--reset_tick", type="int", default="100000",
                      help="reset the access metadata for blocks\
...
def create_system(options, full_system, system, dma_ports, bootmem,
    ...
    if buildEnv['PROTOCOL'] != 'FS_MESI_Blocking':
        fatal("This script requires the FS_MESI_Blocking \
    ...
    for i in range(options.num_cpus):
        ...
        #others_access_metadata = FSOptionalPerCoreState()
        ...
        l1_cntrl = L1Cache_Controller(
            ...
            L1Dcache=l1d_cache,
            # FSPerCoreODStore=per_core_od_table,
            OptionalOwnAccessMetadata=own_access_metadata,
            # OptionalOtherAccessMetadata=others_access_metadata,
