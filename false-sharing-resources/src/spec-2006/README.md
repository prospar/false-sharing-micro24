...
### Prospar-running options

```
--benchmark=MUTEX-hashtable --size=test --kernel=../linux-kernel/vmlinux-4.19.83 --disk=disk-image/spec-2006/prospar-benchmarks-image/prospar-benchmarks --report_pc -l --cpu_type=timing --mem_sys=FS_MESI_DETECTION --num_cpus=4
```